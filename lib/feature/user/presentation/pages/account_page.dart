...
class AccountPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final user = DummyUsers.loggedInUser;
    return Scaffold(
        ...
        children: [
          ...
          _Section(title: 'Account', items: [
            _MenuItem(icon: Icons.credit_card_outlined,
                ...
                onTap: () {}),
            _MenuItem(icon: Icons.phone_android_outlined,
          ...
          Center(
            child: Text('Version ${DummyUsers.loggedInUser['username']}',
...
class _MenuItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      leading: Icon(icon, color: AppColors.textSecondary, size: AppSizes.iconLG),
      title: Text(label, style: AppTextStyles.bodyMedium.copyWith(
        color: AppColors.textPrimary,
      )),
      trailing: const Icon(Icons.chevron_right,
          color: AppColors.textTertiary, size: AppSizes.iconLG),
      onTap: onTap,
    );
  }
}